...
- [src/clinical-dsl.langium](src/clinical-dsl.langium) -  The grammar definition of your language
- [src/clinical-dsl-module.ts](src/clinical-dsl-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/clinical-dsl-validator.ts](src/clinical-dsl-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [syntaxes/clinical-dsl.tmLanguage.json](syntaxes/clinical-dsl.tmLanguage.json) - Textmate based syntax highlighting instructions.
