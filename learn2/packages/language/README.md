...
- [src/medication.langium](src/medication.langium) -  The grammar definition of your language
- [src/medication-module.ts](src/medication-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/medication-validator.ts](src/medication-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [syntaxes/medication.tmLanguage.json](syntaxes/medication.tmLanguage.json) - Textmate based syntax highlighting instructions.
