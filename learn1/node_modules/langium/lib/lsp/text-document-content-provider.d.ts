 ...
 */
export declare class DefaultTextDocumentContentProvider implements TextDocumentContentProvider {
    ...
    provideTextDocumentContent(params: TextDocumentContentParams, _cancellationToken: CancellationToken): Promise<TextDocumentContentResult | undefined>;
}
//# sourceMappingURL=text-document-content-provider.d.ts.map