...
export class DefaultHydrator {
    constructor(services) {
        ...
        this.cstNodeBuilder = new CstNodeBuilder();
    ...
    hydrateCstLeafNode(cstNode) {
        ...
        return new LeafCstNodeImpl(cstNode.offset, cstNode.length, cstNode.startLine, cstNode.startColumn, cstNode.endLine, cstNode.endColumn, tokenType, cstNode.hidden);
    }
    getTokenType(name) {
